    ...
    return (
        <Container>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to Approveage, the software program provided by the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Approveage Inc., 986 Heather Street, Woodstock, ON N4S4W5.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Approveage, accessible from <a href="https://www.approveage.com/" rel="external nofollow noopener" target="_blank">https://www.approveage.com</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: <a href="mailto:admin@approveage.com" className="__cf_email__" data-cfemail="452421282c2b05243535372a33202422206b262a28">Our Email</a></li>
            </ul><script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
        </Container>
    )
}

export const Route = createLazyFileRoute("/privacy")({ component: Privacy })